...
\texttt{sampling = (x1 in (0.0 to 1.0 by 0.5)) x (x2 in (0.0 to 1.0 by 0.5))}


 - LHS Sampling

\texttt{sampling = LHS(100,x1 in (0.0,1.0),x2 in (0.0,1.0))}

 - Sobol sampling

\texttt{sampling = SobolSampling(100,x1 in (0.0,1.0),x2 in (0.0,1.0))}
