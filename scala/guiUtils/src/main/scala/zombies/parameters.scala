...
object parameters {
  ...
  val infectionRange = Parameter("infectionRange", Doubles(0.0, 1.0, 0.1, physic.infectionRange, 0.0), Variable)
  val walkSpeed = Parameter("walkSpeed", Doubles(0.0, 1.0, 0.1, physic.walkSpeed, 0.0), Variable)


  val zombieRunSpeed = Parameter("zombieRunSpeed", Doubles(0.0, 1.0, 0.1, physic.humanRunSpeed, 0.0), Variable)
  val zombiePerception = Parameter("zombiePerception", Doubles(0.0, 5.0, 0.1, physic.zombiePerception, 0.0), Variable)
  val zombieMaxRotation = Parameter("zombieMaxRotation", Doubles(0.0, 180.0, 1.0, physic.zombieMaxRotation, 0.0), Variable)
  val zombiePheromonEvaporation = Parameter("zombiePheromonEvaporation", Doubles(0.0, 1.0, 0.05, physic.pheromonEvaporation, 0.0), Variable)


  val humanRunSpeed = Parameter("humanRunSpeed", Doubles(0.0, 1.0, 0.1, physic.humanRunSpeed, 0.0), Variable)
  val humanPerception = Parameter("humanPerception", Doubles(0.0, 5.0, 0.1, physic.humanPerception, 0.0), Variable)
  ...
  val humanFollowProbability = Parameter("humanFollowProbability", Doubles(0.0, 1.0, 0.1, physic.humanFollowProbability, 0.0), Variable)
  ...
  val humanInformedRatio = Parameter("humanInformedRatio", Doubles(0.0, 1.0, 0.1, physic.humanInformedRatio, 0.0), Variable)
